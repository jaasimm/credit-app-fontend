...
const styles = {
  container: {
    display: "grid",
    gridTemplateColumns: "repeat(4, 1fr)", // fixed 3-column layout
    gap: "20px",
    padding: "20px",
  },
  card: {
...
const AdminLoans: React.FC = () => {
  const stats = [
    ...
    { label: "Savings", value: "450,000", icon: <MdSavings /> },
    { label: "Repaid Loans", value: "30", icon: <BsFillPersonCheckFill /> },
    { label: "Cash Received", value: "1,000,000", icon: <FcAcceptDatabase /> },
     { label: "Active Users", value: "20", icon: <BsFillPersonCheckFill /> },
    { label: "Other Accounts", value: "100", icon: <FcAcceptDatabase /> },
  ];
