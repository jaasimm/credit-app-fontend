...
const VerifiedLoans: React.FC = () => {
  const [loans, setLoans] = useState<Loan[]>([
    { reason: 'John Obi njhnbv', amount: '₦50,000.00', date: 'June 08, 2021', status: 'Pending' },
    { reason: ' Obi mnbgvcdfr', amount: '₦100,000.00', date: 'June 07, 2021', status: 'Verified' },
    { reason: 'bvcdsw John Obi', amount: '₦100,000.00', date: 'June 07, 2021', status: 'Rejected' },
    { reason: 'John Obi mnbhgtrcs', amount: '₦100,000.00', date: 'May 27, 2021', status: 'Approved' },
  ]);
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '700px' }}>
        <thead>
          <tr style={{ backgroundColor: '#f9f9f9', textAlign: 'left' }}>
            <th style={{ padding: '12px' }}>User recent activity</th>
